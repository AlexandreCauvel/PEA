...
Once inhibitor intercalation and corrosion performance had been established, a polyurethane organic topcoat was applied to the inhibitor-intercalated planar specimens and its adhesion was evaluated. This step was omitted for vanadate-intercalated samples, for which topcoat compatibility had already been demonstrated in prior work.

With the multilayer coating system validated on planar substrates, the procedure was subsequently extended to geometrically complex substrates. To assess the spatial extent and uniformity of coating deposition within the complex geometries, cross-sectional analysis was conducted on representative specimens.
...
To validate these observations quantitatively, spectral fitting using the software developed in Section~\ref{sec:fitting_software} was performed to evaluate the evolution of $R_{\text{ct}}$ and $C_{\text{dl}}$ over the full immersion period. The results are presented in Figure~\ref{fig:Rct_Cdl_evolution}.
...
Based on these results, MBT, \ce{NaVO3}, and L-cysteine were identified as the 
best-performing inhibitors among those evaluated and were therefore selected for 
subsequent incorporation into the ZnAl--LDH coating system.
...
Following successful inhibitor intercalation, the corrosion performance of the LDH-based coatings was evaluated by immersing the specimens in a \qty{0.05}{\molar} \ce{NaCl} solution and conducting EIS measurements at regular intervals over a total immersion period of \qty{168}{\hour}. The resulting spectra were fitted using the software developed in Section~\ref{sec:fitting_software}, and the extracted $R_{\text{ct}}$ and $C_{\text{dl}}$ values were compared across the different inhibitor systems to assess their relative corrosion protection performance. Potentiodynamic polarisation (PDP) measurements were additionally conducted to provide complementary kinetic information, and optical inspection of the specimen surfaces was carried out at the end of the immersion period. The impedance spectra at \qty{1}{\hour} and \qty{168}{\hour}, the evolution of $R_{\text{ct}}$ and $C_{\text{dl}}$ over the full immersion period, the PDP curves, and optical images of the final surface condition are presented in Figures~\ref{fig:} to~\ref{fig:}.
