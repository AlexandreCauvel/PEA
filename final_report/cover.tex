...
\begin{figure}[htbp]
   ...
   \begin{subfigure}[b]{0.24\textwidth}
    ...
    \begin{subfigure}[b]{0.24\textwidth}
        ...
        \label{fig:Zn_I}
    \end{subfigure}
    \caption{Painel comparativo SEM-EDS em disposição compacta de 2x4.}
    \label{fig:sem_eds_I}
\end{figure}
