...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{figs/Rct_Cdl_evolution.pdf} 
...
To identify the most suitable pre-treatment for LDH growth, SEM and EDS analyses were conducted on specimens subjected to the chemical pre-treatment, the industrial pre-treatment, and mechanical polishing, the latter serving as a reference condition. The results are presented in Figures~\ref{fig:sem_eds_I} to~\ref{fig:sem_eds_III}.
...
\begin{figure}[htbp]
   ...
   \begin{subfigure}[b]{0.24\textwidth}
    ...
    \begin{subfigure}[b]{0.24\textwidth}
        ...
        \label{fig:Zn_I}
    \end{subfigure}
    \caption{SEM-EDS of polished samples.}
    \label{fig:sem_eds_I}
\end{figure}
...
\begin{figure}[htbp]
   ...
   \begin{subfigure}[b]{0.24\textwidth}
    ...
    \begin{subfigure}[b]{0.24\textwidth}
        ...
        \label{fig:Zn_II}
    \end{subfigure}
    \caption{SEM-EDS of chemically etched samples.}
...
\begin{figure}[htbp]
   ...
   \begin{subfigure}[b]{0.24\textwidth}
    ...
    \begin{subfigure}[b]{0.24\textwidth}
        ...
        \label{fig:Zn_III}
    \end{subfigure}
    \caption{SEM-EDS of industrially etched samples.}
