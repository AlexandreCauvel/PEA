...
In the first part of this work, a pre-selection of corrosion inhibitors was conducted based on EIS measurements and subsequent spectral fitting using the software developed in Section~\ref{sec:fitting_software}. The impedance spectra acquired at \qty{1}{\hour} and \qty{168}{\hour} of immersion are presented in Figures~\ref{fig:} to~\ref{fig:}, together with the evolution of $R_{\text{ct}}$ and $C_{\text{dl}}$ over the full immersion period.
