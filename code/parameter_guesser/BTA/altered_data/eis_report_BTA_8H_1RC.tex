...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        $R_{0}$ & $\Omega$ & $[1.0e-03, 1.0e+03]$ & $7.59e+01 \pm 5.7e-01$ \\ \hline
        $R_{1}$ & $\Omega$ & $[1.0e+00, 1.0e+08]$ & $8.31e+04 \pm 1.1e+03$ \\ \hline
        $Q_{1}$ & $\Omega$$^{-1}$ sec$^{a}$ & $[1.0e-11, 1.0e-03]$ & $1.21e-05 \pm 1.1e-07$ \\ \hline
        $n_{1}$ & - & $[5.0e-01, 1.0e+00]$ & $8.70e-01 \pm 1.9e-03$ \\ \hline
        \textbf{$\chi^2$} & - & -  & $8.159e-04$ \\ \hline
...
\begin{center}
    \includegraphics[width=0.7\textwidth]{plots_Cauvel_3_BTA_8H_1RC.pdf}
