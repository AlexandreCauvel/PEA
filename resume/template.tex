...
Finally, a polyurethane topcoat was applied to planar and complex-geometry specimens via anodic electrodeposition. Cross-sectional SEM-EDS confirmed a continuous multilayer architecture with robust interfacial adhesion. The underlying LDH layer was clearly resolved by its distinct Zn and O signature, alongside the specific intercalated species (S for MBT, V for \ce{NaVO3}). Notably, the topcoat thickness varied significantly between systems (\qty{16.47 \pm 0.55}{\micro\meter} for MBT vs. \qty{26.48 \pm 1.08}{\micro\meter} for \ce{NaVO3}), attributed to the distinct electrical and morphological properties of the amorphous remnant film versus the intact crystalline LDH during electrodeposition. Crucially, the cross-sections visually confirmed the persistence of large Fe--Mn intermetallic particles at the alloy surface, highlighting the critical challenge of protecting these active micro-galvanic sites in AC46000. Ultimately, uniform coverage was achieved on complex geometries, validating the practical feasibility of the complete multilayer system.
