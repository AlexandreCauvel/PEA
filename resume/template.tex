...
The resulting multilayer architecture was characterised using cross-sectional SEM-EDS to evaluate local coating thickness, interfacial adhesion, and elemental distribution, complemented by macroscopic dry film thickness measurements using an Elcometer gauge.

\section{Results and Discussion}

\subsection{Inhibitor Pre-selection}
The EIS pre-selection identified MBT, \ce{NaVO3}, and L-cysteine as the most effective inhibitors, demonstrating $R_{\text{ct}}$ values in excess of \qty{100}{\kilo\ohm\centi\meter\squared} and stable $C_{\text{dl}}$ values on the order of \qty{10}{\micro\farad\per\square\centi\meter}, indicative of active and durable surface film formation. Conversely, the poorly protected systems exhibited exceptionally high $C_{\text{dl}}$ values. As these represent an effective capacitance derived from a 2RC model over a restricted frequency window, they reflect both extensive water uptake and the lumped contributions of unresolved low-frequency mass transport processes. Sodium molybdate provided negligible protection, while BTA and 8-HQ exhibited intermediate and transient protection, failing to maintain stable surface films over extended immersion.

\begin{center}
\includegraphics[width=0.9\linewidth]{Figures/Rct_Cdl_evolution_inhibitors_resume.pdf}
\captionof{figure}{Evolution of $R_{\text{ct}}$ and $C_{\text{dl}}$ over the \qty{168}{\hour} immersion period for the pre-selected inhibitors.}
...
In stark contrast, the attempted intercalation of MBT resulted in the destruction of the LDH crystalline structure. This structural degradation is fundamentally attributed to the deprotonated, negatively charged thiolate anions (\ce{-S^-}) present in the alkaline intercalation solutions. These thiolate groups exhibit an exceptionally strong coordination affinity for \ce{Zn^{2+}} ions, acting as powerful chelating agents that actively extract zinc from the host brucite layers, forming soluble zinc-thiolate complexes and collapsing the LDH crystal lattice \cite{Tedim2010}. Consequently, this system lacks a structured crystalline reservoir for controlled release. Instead, the protective mechanism relies on the passive barrier properties of the amorphous remnants, comprising zinc and aluminium hydroxides, combined with the direct chemisorption of MBT molecules onto both the exposed alloy surface and these residual hydroxide sites.
...
\begin{center}
\includegraphics[width=0.9\linewidth]{Figures/Rct_Cdl_evolution_LDH2_resume.pdf}
\captionof{figure}{Evolution of $R_{\text{ct}}$ and $C_{\text{dl}}$ over the \qty{168}{\hour} immersion period for the LDH-2 specimens.}
...
Finally, a polyurethane topcoat was applied to planar and complex-geometry (CG) specimens via anodic electrodeposition. The complex-shaped specimens were manufactured via investment casting, and the author gratefully acknowledges Prof. Georgina Miranda and Pedro Araújo for their assistance in producing these components. A photograph of the complex geometry is presented in Figure~\ref{fig:complex_shape_photo}.

\begin{center}
    \begin{minipage}[b]{0.3\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/cg_MBT_1.jpg}
        \par\vspace{2pt}
        \small (a) CG 1
    \end{minipage}\hfill
    \begin{minipage}[b]{0.3\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/cg_MBT_2.jpg}
        \par\vspace{2pt}
        \small (b) CG 2
    \end{minipage}\hfill
    \begin{minipage}[b]{0.3\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/cg_NaVO3_2.jpg}
        \par\vspace{2pt}
        \small (c) CG 3
    \end{minipage}
    
    \captionof{figure}{Optical macrographs of polyurethane-coated complex-shaped specimens.}
    \label{fig:complex_shape_photo}
\end{center}

Cross-sectional SEM-EDS confirmed robust interfacial adhesion and resolved the multilayer architecture, identifying the LDH layer (Zn, O) and specific intercalated species (S for MBT, V for \ce{NaVO3}). Local thickness measurements from these cross-sections revealed a thinner coating for MBT (\qty{16.5}{\micro\meter}) compared to \ce{NaVO3} (\qty{26.5}{\micro\meter}), attributed to the amorphous remnant film versus the intact crystalline LDH. Complementing this localised analysis, macroscopic dry film thickness evaluations performed using an Elcometer gauge revealed average topcoat thicknesses of \qty{31.7 \pm 5.7}{\micro\meter} for the \ce{NaVO3}-intercalated specimens and \qty{28.8 \pm 5.5}{\micro\meter} for the MBT-intercalated specimens. Both systems exhibited substantial standard deviations (approximately 18--19\% relative variation), demonstrating the heterogeneous nature of the coating thickness across the macroscopic surface. Crucially, cross-sections visually confirmed the persistence of large Fe--Mn intermetallic particles at the alloy surface, highlighting the challenge of protecting these active micro-galvanic sites. Despite these thickness variations, conformal coverage was achieved on the complex geometries, validating the system's practical feasibility.

\section{Conclusions}
This work investigated ZnAl--LDH conversion coatings on the AC46000 die-cast alloy as a chromate-free aerospace alternative. While \ce{NaVO3} was successfully intercalated and demonstrated active chloride-triggered release, MBT destroyed the LDH crystalline structure via aggressive zinc chelation, yet remained adsorbed on the surface, actively inhibiting corrosion. Corrosion evaluation revealed that aggressive industrial pre-treatments detrimentally exposed subsurface IMPs, whereas a milder chemical pre-treatment yielded significant improvements: MBT provided excellent initial barrier protection and \ce{NaVO3} offered sustained active protection. However, long-term performance remains limited by the inability of these inhibitors to passivate the highly prevalent Fe--Mn intermetallic particles. Ultimately, the successful conformal deposition of a polyurethane topcoat via anodic electrodeposition validated the practical feasibility of protecting complex aerospace geometries.
